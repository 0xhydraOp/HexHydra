...
[![Version](https://img.shields.io/badge/version-v3.9.3-blue)](https://github.com/0xhydraOp/HexHydra/releases/tag/v3.9.3)
...
`versionCode` + `versionName` in `app/build.gradle` are the source of truth; `CHANGELOG.md` records every release. Current: **v3.9.3** (versionCode 68).
